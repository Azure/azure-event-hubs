...
public final class ReactorDispatcher
{
    ...
    private final Selectable schedulerSelectable;
    ...
    public ReactorDispatcher(final Reactor reactor) throws IOException
    {
        ...
        this.schedulerSelectable = this.reactor.selectable();

        this.schedulerSelectable.setChannel(this.ioSignal.source());
        this.schedulerSelectable.onReadable(this.workScheduler);
        this.schedulerSelectable.onFree(new CloseHandler());

        this.schedulerSelectable.setReading(true);
    ...
    public void free()
    {
        if (schedulerSelectable != null)
            schedulerSelectable.free();
    }
