...
An Event Hubs namespace is required to send or receive from any Event Hubs service. See [this guide](GUIDE_LINK) for instructions on getting an Event Hubs Kafka endpoint. Make sure to copy the Event Hubs connection string for later use.
